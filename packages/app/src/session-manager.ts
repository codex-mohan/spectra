...
function getBranchPath(entries: SessionEntry[], entryId?: string): SessionEntry[] {
...
export class SessionManager {
	...
	buildContext(session: Session, entryId?: string): SessionContext {
		...
		const messages = branch.filter((e): e is MessageEntry => e.type === 'message').map((e) => e.message);
