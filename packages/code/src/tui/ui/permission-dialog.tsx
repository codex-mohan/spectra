...
export function PermissionDialog({
  ...
  return (
    <box position="absolute" left={0} right={0} top={0} bottom={0} backgroundColor={c.bgOverlay}>
      <box position="absolute" left={dialogLeft} top={dialogTop} width={dialogWidth} height={dialogHeight} backgroundColor={c.bg}>
        {/* Title */}
        <box height={1} paddingTop={1} paddingX={2} flexDirection="row" justifyContent="center">
          <text fg={c.accent} attributes={1}>Spectra Permission</text>
        </box>
        ...
        <box paddingX={2} flexDirection="column">
          <box height={1} flexDirection="row" gap={1}>
            <text fg={c.dim} flexShrink={0}>Tool:</text>
            <text fg={c.text} overflow="hidden" wrapMode="none" flexGrow={1}>{request.tool ?? request.permission}</text>
          </box>
          <box height={1} flexDirection="row" gap={1}>
            <text fg={c.dim} flexShrink={0}>Pattern:</text>
            <text fg={c.info} overflow="hidden" wrapMode="none" flexGrow={1}>{request.permission} {request.pattern}</text>
          </box>
        </box>
