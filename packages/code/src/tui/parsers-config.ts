 ...
 * Each entry registers a WASM grammar + highlight queries for a language.
 * OpenTUI ships built-in parsers for javascript, typescript, markdown, and zig;
 * this config adds the rest.
 */
export const parsers = [
	...
	{
		filetype: 'sql',
		wasm: 'https://github.com/DerekStride/tree-sitter-sql/releases/download/v0.7.0/tree-sitter-sql.wasm',
		queries: {
			highlights: [
